...
static struct ufs_dev_fix ufs_fixups[] = {
	...
	UFS_FIX(UFS_VENDOR_SKHYNIX, "hC8HL1",
		UFS_DEVICE_QUIRK_HS_G1_TO_HS_G3_SWITCH),
	UFS_FIX(UFS_VENDOR_SKHYNIX, UFS_ANY_MODEL, UFS_DEVICE_NO_VCCQ | UFS_DEVICE_SLOW_WRITE),  /* Power optimization */
	UFS_FIX(UFS_VENDOR_SAMSUNG, UFS_ANY_MODEL, UFS_DEVICE_NO_VCCQ | UFS_DEVICE_FLUSH_BIAS),  /* Speed optimization */
	UFS_FIX(UFS_VENDOR_WDC, UFS_ANY_MODEL, UFS_DEVICE_READ_AHEAD_LIMIT | UFS_DEVICE_WRITE_BURST),  /* Performance */
	UFS_FIX(UFS_VENDOR_TOSHIBA, UFS_ANY_MODEL, UFS_DEVICE_POWER_SAVE | UFS_DEVICE_IDLE_TIMEOUT),  /* Battery saving */
	UFS_FIX(UFS_VENDOR_SKHYNIX, "h08aM1", UFS_DEVICE_NO_VCCQ),  /* Specific model fix */
	UFS_FIX(UFS_VENDOR_SKHYNIX, "hC8GL1", UFS_DEVICE_NO_VCCQ),  /* Specific model fix */
	UFS_FIX(UFS_VENDOR_SKHYNIX, "h08aM1", UFS_DEVICE_NO_VCCQ | UFS_DEVICE_SLOW_WRITE),  /* Combined fix */
	UFS_FIX(UFS_VENDOR_SAMSUNG, UFS_ANY_MODEL, UFS_DEVICE_NO_VCCQ | UFS_DEVICE_FLUSH_BIAS | UFS_DEVICE_READ_AHEAD),  /* Combined fix */
	END_FIX
};
